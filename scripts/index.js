...
const profileInputName = profileForm.querySelector('.edit-form__input-text_input_name');
const profileInputDescription = profileForm.querySelector('.edit-form__input-text_input_description');
